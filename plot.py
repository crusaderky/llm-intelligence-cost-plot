...
MODELS = [
    ...
    Model.reduced_price(
        ...
        34.53,
        ModelPrice(input=0.0038, output=0.0819, cache_read=0.1339),
    ...
    Model.reduced_price(
        ...
        35.01,
        ModelPrice(input=0.0045, output=0.0913, cache_read=0.2186),
        nominal_price=ModelPrice(input=0.44, output=1.32, cache_read=0.014),
        cheapest_price=ModelPrice(input=0.22, output=0.66, cache_read=0.007),
    ),
    Model("DeepSeek", "DeepSeek V4 Pro 0813", 36.28, 0.6740),
    Model.reduced_price(
        "Tencent",
        "Hy3",
        25.77,
    ...
    Model("OpenAI", "GPT-5.6 Sol (medium)", 39.48, 0.5050),
    Model("OpenAI", "GPT-5.6 Sol (high)", 42.50, 0.8080),
    Model("OpenAI", "GPT-5.6 Sol (xhigh)", 44.14, 1.1844),
    Model("OpenAI", "GPT-5.6 Sol (max)", 47.06, 1.9885),
