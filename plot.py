...
DATA = [
    ...
    ("DeepSeek V4 Flash 0731", 0.11, 52),
    ("DeepSeek V4 Flash 0731 (3pp)", 0.11 * 0.18 / 0.66, 52),
    ("DeepSeek V4 Pro 0813", 0.25, 53),
    ("Gemini 3.7 Flash", 0.40, 56),
    ("Muse Spark 1.2", 0.40, 57),
    ("GLM-5.3", 0.68, 60),
    ("GLM-5.3 (3pp)", 0.68 * 2.20 / 4.40, 60),
    ("Qwen3.8 Max", 1.09, 58),
    ("Kimi K3", 0.84, 60),
    ("Grok 4.6", 0.84, 61),
    ("GPT-5.6 Luna", 0.05, 52),
    ("GPT-5.6 Terra", 0.51, 57),
    ("GPT-5.6 Sol (medium)", 0.37, 56),
    ("GPT-5.6 Sol (high)", 0.55, 57),
    ("GPT-5.6 Sol (xhigh)", 0.81, 59),
    ("GPT-5.6 Sol (max)", 1.23, 61),
    ("Claude Opus 4.7", 2.23, 55),
    ("Claude Opus 4.8", 2.03, 57),
    ("Claude Sonnet 5", 1.72, 55),
    ("Claude Opus 5 (medium)", 0.72, 59),
    ("Claude Opus 5 (high)", 1.23, 61.5),
    ("Claude Opus 5 (xhigh)", 1.80, 62.5),
    ("Claude Opus 5 (max)", 2.34, 63),
    ("Claude Fable 5", 3.14, 62),
]
